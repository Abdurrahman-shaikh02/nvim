return { -- Autocompletion
  ...
  config = function()
    ...
    -- track whether we just confirmed with <Tab>
    local just_confirmed = false
        ...
        ['<Tab>'] = cmp.mapping(function(fallback)
          if cmp.visible() then
            if not just_confirmed then
              cmp.confirm({ select = true }) -- confirm current/first suggestion
              cmp.complete()                 -- reopen menu so next <Tab> can move next
              just_confirmed = true
            else
